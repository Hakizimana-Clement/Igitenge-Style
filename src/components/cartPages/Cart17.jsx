...
export default function Cart1() {
  ...
  const [countNow, setCountNow] = useState(350);

  function handleAddClick(e) {
    e.preventDefault();
    const addOne = count + 1;
    setCount(addOne);
    const addPriceOne = addOne * 350;
  ...
  function handleSubstractClick(e) {
    ...
    if (count <= 1) {
      ...
      setCount(minusOne);
      const minusPriceOne = minusOne * 350;
  ...
  ////////////////////////////////////////////
  const priceForStripe = count * 35000;
      ...
      <div className="row cart">
        ...
        <div className="col-lg-5 cart-text ">
          <div>
            ...
            <h3>Description:</h3>
            <ul>
              <li>All over print knit</li>
              <li>Contrast rib knit at cuff, collar, and waist﻿</li>
              <li>45% cotton/55% acrylic</li>
            </ul>
            <h3>Care:</h3>
            <ul>
              <li>Gentle cold hand wash. Do not bleach or soak</li>
            </ul>
            {/* <p>
