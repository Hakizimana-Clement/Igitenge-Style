      ...
      <div className="row cart">
        ...
        <div className="col-lg-5 cart-text ">
          <div>
            ...
            <h3>Description:</h3>
            <ul>
              <li>All-Over-Print Traditional Top</li>
              <li>Hidden Button-Up at Placket</li>
              <li>2 Button Closure on the Cuff</li>
              <li>2 Vents at the Sides</li>
              <li>100% Cotton Body</li>
              <li>​97% Cotton/3% Lycra Placket and Welt Pocket</li>
            </ul>
            <h3>Care:</h3>
            <ul>
              <li>
