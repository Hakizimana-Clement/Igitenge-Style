      ...
      <div className="row cart">
        <div className="col-lg-7">
          <div className="cart-image">
            <img
              src="https://cdn.shopify.com/s/files/1/0684/2619/products/tops-olu-short-sleeve-mandarin-button-up-african-print-shirt-black-brown-geometric-2_1000x1400.jpeg?v=1540227622"
              alt="placeholder"
              className="img-fluid"
            />
          </div>
        ...
        <div className="col-lg-5 cart-text ">
          <div>
            ...
            <h3>Description:</h3>
            <ul>
              <li>100% Cotton, African wax print with solid trimming</li>
              <li>inside collar, cuff, and top of chest pocket</li>
              <li>2 buttons closure on cuff</li>
            </ul>
            <h3>Care:</h3>
            <ul>
              <li>
                Machine wash cold. Use mild detergent. Do not bleach. Hang to
                dry. Iron if needed
              </li>
            </ul>
          </div>
